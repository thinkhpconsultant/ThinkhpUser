...
using ThinkhpUserAPI.Repository.Service;
...
// connecton setting //
var connectionString = builder.Configuration.GetConnectionString("ThinkHPUsersDB");
builder.Services.AddDbContext<ThinkHPUsersContext>(x => x.UseSqlServer(connectionString));
